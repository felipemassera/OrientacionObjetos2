...
public class WallPostUI {
	private static final Logger logger = Logger.getLogger("WallPostUI");//creo log con nombre de clase
	...
	public WallPostUI() {
		...
		logger.info("La aplicación ha iniciado."); // agrego log de creacion
	}
	...
	private void wireComponents() {
		this.like.addActionListener(e -> {
			...
			logger.info("Clic en 'Me gusta'");//agrego log de me gusta!
		});

		this.dislike.addActionListener(e -> {
			this.wallPost.dislike();
			this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
			logger.info("Clic en 'No me gusta'");//agrego log de No me gusta!
		});
